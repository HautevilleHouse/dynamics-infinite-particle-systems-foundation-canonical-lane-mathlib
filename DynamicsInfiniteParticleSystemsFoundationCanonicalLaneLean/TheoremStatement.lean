import DynamicsInfiniteParticleSystemsFoundationCanonicalLaneLean.ReviewerBridge

/-!
# Theorem Statement Layer

This module internalizes the theorem-facing object for Dynamics Infinite Particle Systems Foundation.
-/
